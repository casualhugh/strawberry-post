...
namespace {
constexpr uint32_t kBusyTimeoutMs = 15000;
...
void EPD_READBUSY(void)
{
  ...
  {
    if (millis() - startedAt >= kBusyTimeoutMs)
    {
...
bool EPD_LastOperationSucceeded(void) { return operationSucceeded; }
void EPD_ResetOperationStatus(void) { operationSucceeded = true; }
/*******************************************************************
    函数说明:硬件复位函数
    入口参数:无
